...
def run_given_test_cases():
    ...
    run_single_test("tests_given/tc_input_handling_c1.txt")
    ...
    run_single_test("tests_given/tc_input_handling_c2.txt")
    ...
    run_single_test("tests_given/tc_input_handling_c3.txt")
    ...
    run_single_test("tests_given/tc_input_handling_c4.txt")
    ...
    run_single_test("tests_given/tc_noarb_c1.txt")
    ...
    run_single_test("tests_given/tc_noarb_c2.txt")
    ...
    run_single_test("tests_given/tc_noarb_c3.txt")
    ...
    run_single_test("tests_given/tc_arb_c2.txt")
...
def run_extra_test_cases():
    ...
    # Abritrage exists
    run_single_test("tests_extra/tc_arb_c1.txt")
    print("^ Expected Output:\nArbitrage detected!\nArbitrage cycle: A -> B -> C -> A.\nProfit: 5.30%.")
    print("\n--- End of case. ----\n")

    run_single_test("tests_extra/tc_arb_c2.txt")
    print("^ Expected Output:\nArbitrage detected!\nArbitrage cycle: A -> D -> C -> A.\nProfit: 71.10%.")
    print("\n--- End of case. ----\n")

    run_single_test("tests_extra/tc_arb_c3.txt")
    print("^ Expected Output:\nArbitrage detected!\nArbitrage cycle: AUD -> GBP -> AUD.\nProfit: 0.70%")
    print("\n--- End of case. ----\n")

    # No arbitrage
    run_single_test("tests_extra/tc_noarb_c1.txt")
    print("^ Expected Output:\nNo arbitrage detected.\nBest conversion rate from A to C: 1.5000.\nBest path: A -> C.")
    print("\n--- End of case. ----\n")

    run_single_test("tests_extra/tc_noarb_c2.txt")
    print("^ Expected Output:\nNo arbitrage detected.\nBest conversion rate from A to B: 1.0000.\nBest path: A -> B.")
    print("\n--- End of case. ----\n")

    run_single_test("tests_extra/tc_noarb_c3.txt")
    print("^ Expected Output:\nNo arbitrage detected.\nBest conversion rate from A to B: 0.9000.\nBest path: A -> B.")
    print("\n--- End of case. ----\n")
